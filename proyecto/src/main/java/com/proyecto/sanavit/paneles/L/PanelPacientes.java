...
//  * Con resumen lateral de total de pacientes
//  */
// public class PanelPacientes extends JPanel {

//     private JTable tablaPacientes;
//     private DefaultTableModel modeloTabla;
//     private JTextField txtNombre, txtIdentificacion, txtCorreo, txtEdad, txtTelefono;
...
//                 "ID", "Nombre", "Identificación", "Correo", "Edad", "Teléfono", "Sexo", "Usuario Asociado"
//         }, 0) {
//             @Override
...
//                     comboSexo.setSelectedItem(modeloTabla.getValueAt(fila, 6).toString());
//                     comboUsuario.setSelectedItem(modeloTabla.getValueAt(fila, 7).toString());
//                 }
//             }
//         });
//     }
...
//             if (nombre.isEmpty() || iden.isEmpty() || correo.isEmpty() || idUsuario <= 0) {
//                 JOptionPane.showMessageDialog(this, "⚠️ Todos los campos son obligatorios.");
//                 return;
//             }

//             Paciente nuevo = new Paciente(0, nombre, iden, correo, edad, tel, sexo, idUsuario);
...
//             JOptionPane.showMessageDialog(this, "⚠️ La edad debe ser un número.");
//         }
//     }
...
//             Paciente actualizado = new Paciente(id, nombre, iden, correo, edad, tel, sexo, idUsuario);
